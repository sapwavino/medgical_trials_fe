    ...
    <div class="flex flex-wrap -mx-3">
        ...
        <div class="bg-gray-100 p-6 rounded-lg shadow-lg mb-6">
          ...
          >
            ...
            <template v-else>
              ...
              <p class="text-gray-500">Upload the trial criteria PDF File</p>
            </template>
            <input
              ref="trialFileInput"
              type="file"
      ...
      <div v-else class="px-3 grid grid-cols-2 w-full">
        ...
        <div class="bg-gray-100 p-6 rounded-lg shadow-lg mb-6">
          ...
          >
            <template v-if="patientFile">
              ...
              <button
                ...
                class="mt-4 bg-red-700 text-white px-4 py-2 rounded-lg hover:bg-red-600 focus:outline-none text-xs"
              >
          ...
          <button
            @click="goBack"
            class="mt-4 ml-2 px-3 rounded-xl mx-2 bg-amber-500 text-gray-50 py-2 font-bold focus:outline-none"
          >
            ← Start over
          </button>
          ...
          <button
            ...
            class="mt-4 mx-2 px-3 text-white py-2 rounded-xl  focus:outline-none bg-emerald-600 disabled:bg-gray-500 disabled:cursor-not-allowed"
          >
          Submit ✔︎ 
          </button>
        </div>
                ...
                >
                  <div v-if="index === 'Claude'">
                    <p>
                      ...
                      ><span
                        :class="{
                          'bg-emerald-500 text-white p-1 text-xs text-center inline-block px-2 shadow-md capitalize rounded-full mt-5':
                            result.evaluation === 'Good candidate',
                          'bg-red-700 text-white p-1 text-xs text-center inline-block px-2 shadow-md capitalize rounded-full mt-5':
                            result.evaluation === 'Bad candidate',
                        }"
                        >{{ result.evaluation }}</span
                      >
                    </p>
                    <p class="mt-3"><strong>Claude Reason: </strong>{{ result.reason }}</p>
                  </div>
                  <div v-else>
                    <p>
